...
namespace Shapes
{
    public class Rectangle : Shape
    {
        ...
        {
            Line Width1 = new Line(myPoints[0], myPoints[1]);
            Line Width2 = new Line(myPoints[2], myPoints[3]);
            Line Height1 = new Line(myPoints[0], myPoints[3]);
            Line Height2 = new Line(myPoints[1], myPoints[2]);
        ...
        {
            Line Diagonal1 = new Line(myPoints[0], myPoints[2]);
            Line Diagonal2 = new Line(myPoints[1], myPoints[3]);
